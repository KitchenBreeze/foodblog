...

{
    ...
    ingredients: {
        "":[
        "3 80g-gelaugte [[brezeln|Brezelteiglinge]] <i>(alternativ 3 angetaute TK-Brezeln)</i>",
        "30g Kochschinken",
        "50g Dosenananas",
...

{
    ...
    steps: [
        ...
        "Den Teig mit einer Teigkarte vorsichtig auf eine bemehlte Arbeitsfläche geben und behutsam zu einem ca. 20cm × 25cm großen Rechteck formen. <b>Dabei möglichst wenig Luft aus dem Teig drücken.</b> Das untere Drittel des Teiges zur Mitte falten, das obere Drittel darüberklappen und die Naht sowie die Enden gut zusammendrücken.",

        "Den Teigstrang anschließend von der Mitte aus gleichmäßig mit den Händen zu einem ca. 35cm langen Strang <i>(optional mit spitz zulaufenden Enden)</i> ausrollen. Auf ein Baguetteblech legen <i>(alternativ funktioniert auch ein mit Backpapier belegtes Backblech)</i>, abdecken und weitere ca. 45min ruhen lassen.",

        "Das Baguette optional drei Mal mit einem scharfen Messer im 45-Grad-Winkel einschneiden. Im vorgeheizten Backofen zunächst 15min backen. Anschließend die Wasserschale aus dem Ofen nehmen und das Baguette weitere ca. 5min fertig backen, bis es goldbraun ist und beim Klopfen auf die Unterseite hohl klingt. <i>(Falls es dir zu dunkel wird, locker mit Alufolie abdecken.)</i>",

        "Aus dem Ofen nehmen und auf einem Kuchengitter mindestens 5min abkühlen lassen."
    ]
},
...
{
    id: "59",
    title: "Mini russischer Zupfkuchen",
    tips: [
    ...
    related: ["3", "57", "37"],
    portions: "1 kleiner Kuchen",
    difficulty: "Einfach",
    rating: 4.6,
    description: "knuspriger, keksiger Schokomürbeteig mit samtiger Quarkfüllung",
    ...
    steps: [
        ...
        "Die Butter für die Füllung in einem kleinen Topf schmelzen und beiseite stellen.",

"Für den Mürbeteig das Mehl, das Kakaopulver, den Zucker, das Salz und den Vanillezucker in einer Schüssel vermengen. Die Kalte Butter in kleine Stücke schneiden, zusammen mit dem Ei in die Schüssel geben und nur solange verkneten, bis ein glatter Teig entsteht.",

"Eine Springform (18cm) am Boden mit Backpapier belegen und an den Ränder einfetten.",

"2/3 des Teiges auf den Boden der Form drücken und dabei einen einigermaßen gleichmäßigen 1,5cm hohen Rand formen.",

"Für die Füllung den Quark mit dem Zucker, der geschmolzenen Butter, das Vanillepuddingpulver, das Salz, den Vanillezucker und die Milch mit einem Schneebesen verrühren. Das Ei unterrühren und die Füllung auf den Boden gießen.",

"Glatt streichen und den restlichen Teig in kleine Stücke zupfen, etwas platt drücken und auf der Oberfläche platzieren.",
...

{
    ...
    description: "Leckere Tortellini in cremiger Parmesansoße mit getrockneten Tomaten und Rucola.",

    /* 🍽️ ZUTATEN */
    ingredients: {

        "": [
            "1,5kg Tortellini <i>(z.B. mit Fleischfüllung)</i>",
            "250ml Kochsahne",
            "160g Parmesan",
            "60g Rucola",
    ...
    steps: [
        ...
        "Den Parmesan fein reiben, die Tomaten in kleinere Stücke schneiden, den Knoblauch schälen und fein hacken. Den Rucola waschen, trocken tupfen und nach Belieben etwas kleiner zupfen.",

        "Etwas Olivenöl in einem Topf erhitzen und die Tortellini im kochenden Salzwasser nach Packungsbeilage garen.",

        "In der Zwischenzeit den Knoblauch kurz im Öl anschwitzen, bis er duftet. Die Tomaten dazugeben und ca. 1-2 Minuten mitbraten. Mit der Sahne ablöschen, die Tortellini mit einer Schaumkelle dazugeben und 2 Kellen Pastawasser hinzufügen. Alles gut umrühren, aufkochen, mit reichlich Pfeffer und etwas Salz würzen und ca. 2-3 Minuten bei mittlerer Hitze köcheln lassen, bis die Soße schön cremig ist.",

        "Den Parmesan unterrühren, bis er geschmolzen ist. Den Topf vom Herd nehmen, den Rucola unterheben und servieren."
...

{
    ...
    description: "Verschiedene Bohnen mit frischen, saftigen Tomaten, cremiger Avocado und leckerem Mozzarella.",
    ...
    /* 👨‍🍳 ZUBEREITUNG */
    steps: [
        "Die Bohnen abgießen, abspülen und gut abtropfen.",

        "Die Tomaten in Scheiben und die Frühlingszwiebeln in feine Ringe schneiden.",

        "Die Mozzarellakugeln abgießen und halbieren.",

        "Für das Dressing alle Zutaten mit einem Milchaufschäumer cremig rühren, mit den restlichen Zutaten in eine große Schüssel geben und gut vermengen.",

        "Die Avocado klein schneiden, einen Teil davon auf dem Salat verteilen und den Rest mit zum Salat dazu reichen."
    ]
},

{
    ...
    description: "Cremige, süß-saure Kirschfüllung in knusprig-zartem Teig und leckeren Streuseln.",
    ...
    /* 👨‍🍳 ZUBEREITUNG */
    steps: [
        "Sowohl die Butter für den Teig als auch für die Streusel in kleine Stücke schneiden und für ca. 5-10min ins Gefrierfach stellen.",

        "In der Zwischenzeit für die Kirschfüllung die Stängel von den Kirschen entfernen, die Kirschen entsteinen, halbieren, in eine Schüssel geben und mit dem Zucker vermengen und ca. 30min ruhen lassen.",

        "Während der Ruhezeit für den Teig das Mehl mit der Stärke und dem Salz, dem Puderzucker und dem Vanillezucker in einer Schüssel vermengen. Die kalte Butter und das Eigelb für den Teig dazugeben und alles kurz zu einem Teig kneten, bis sich alles gut verbunden hat, in Frischhaltefolie wickeln und für mind. 30min im Kühlschrank ruhen lassen.",

        "Für die Streusel das Mehl mit dem Salz und dem Zucker vermengen. Den Rest der eiskalten Butterstücke dazugeben und zu Streuseln krümelig kneten und ebenfalls in den Kühlschrank stellen.",

        "Für die Füllung das Puddingpulver in ca. 3 EL kaltem Wasser auflösen. Die Kirschen mitsamt der ausgetretenen Flüssigkeit und dem Salz in einen Topf geben, unter gelegentlichem Rühren aufkochen und ca. 5min auf mittlerer Hitze köcheln, bis die Kirschen weich sind, dabei etwas mit einem Löffel zerkleinern. Das aufgelöste Puddingpulver und die Zitronenschale unterrühren, erneut aufkochen und ca. 4min bei mittlerer Hitze köcheln, bis es schön eingedickt ist, vom Herd nehmen und beiseite stellen.",

        "Den Ofen auf 180 Grad Ober-/Unterhitze vorheizen und ein großes, hohes 6er-Muffinblech einfetten und mit etwas Mehl bestäuben.",

        "Immer ein Stück Teig nehmen und dünn auf den Boden der Mulde drücken, bis dieser bedeckt ist. Größere Teigstücke nehmen und dünn an den Rand der Mulde drücken, bis der Rand 3/4 der Höhe der Mulde hat. Die Ränder gerade drücken.",

        "Jede Mulde ca. 3/4 der Höhe des Teiges mit Kirschfüllung befüllen, mit Streuseln toppen, im vorgeheizten Backofen ca. 35-40min backen, bis die Ränder goldbraun sind und die Streusel etwas Farbe bekommen haben. Aus dem Ofen nehmen und vollständig auskühlen lassen.",

        "Dann aus der Form lösen, die überstehenden Ränder abschneiden und die Törtchen nach Belieben mit Puderzucker bestreuen."
    ]
},

{
    ...
    description: "Saftig, fluffige Brötchen mit knackigen Kürbiskernen und dünner, knuspriger Kruste.",
    ...
    /* 👨‍🍳 ZUBEREITUNG */
    steps: [
        "Die beiden Mehlsorten und das Wasser in einer Schüssel mit einem Löffel vermengen, bis kein trockenes Mehl mehr zu sehen ist, die Schüssel abdecken, beiseite stellen und etwas ruhen lassen.",

        "In der Zwischenzeit die Kürbiskerne klein hacken, die Karotte schälen, die Enden entfernen und fein raspeln.",

        "Dann das Salz, die Karotten, die Kürbiskerne, die Hefe und das Öl mit zu Mehl und Wasser geben und mit dem Knethaken der Küchenmaschine ca. 8min auf mittlerer bis höchster Stufe kneten, bis sich der Teig vom Schüsselrand löst.",

        "Den Teig mit einem Löffel in eine leicht geölte Box mit Deckel geben, abdecken und 30 min bei Raumtemperatur ruhen lassen. Dann den Teig einmal dehnen und falten. Mit feuchten Händen je ein Stück Rand nehmen, seitlich nach oben ziehen, bis du einen Widerstand spürst, dann zur Mitte klappen und dies einmal rundherum wiederholen, bis du den Teig an jeder Stelle des Rands einmal gedehnt hast. Erneut abdecken, weitere 30min ruhen lassen, den Faltvorgang wiederholen, wieder abdecken und ein letztes Mal ca. 30 min bei Raumtemperatur ruhen lassen.",

        "Nach der Ruhezeit den Teig auf eine leicht bemehlte Arbeitsfläche gleiten lassen und vorsichtig, ohne zu viel Luft rauszudrücken, mit feuchten Händen zu einem ca. 24cm x 20cm großen „Rechteck“ formen und mit einer feuchten Teigkarte 6 ungefähr gleichgroße Teile abstechen und auf ein mit Backpapier belegtes Backblech geben.",

        "Nach Belieben mit weiteren Kürbiskernen toppen, abdecken, weitere 15 min ruhen lassen und den Ofen auf 220 Grad Ober-/Unterhitze vorheizen.",

        "Die Brötchen in den Ofen schieben, den Ofen mit einer Sprühflasche gut beschwaden und 10 min backen. Dann die Ofentür einmal öffnen, den Dampf entweichen lassen und die Brötchen ca. 5 min fertig backen, bis sie sich beim Klopfen auf die Unterseite hohl anhören.",

        "Den Ofen ausschalten, die Ofentür einen Spalt öffnen und die Brötchen darin ca. 5min ruhen lassen, dann aus dem Ofen nehmen, sofort servieren oder auf einem Gitterrost auskühlen lassen."
    ]
},

{
    ...
    description: "Saftige Bananenmuffins mit Schokostückchen.",
    ...
    steps: [
        ...
        "Dann den Ofen auf 180 Grad Ober-/Unterhitze vorheizen und ein Muffinblech mit Papierförmchen auskleiden.",

        "Die Banane mit einer Gabel zerdrücken, die Milch und das Öl untermischen. In einer separaten Schüssel das Mehl mit dem Backpulver, dem Zucker und dem Salz vermengen. Alles unter die Bananenmasse rühren, die Schokolade unterheben und gleichmäßig auf die Förmchen verteilen und ca. 15 min im vorgeheizten Backofen backen.",

        "Aus dem Ofen nehmen und mind. 5 min abkühlen lassen."
    ]
},
...
{ 
    ...
    description: "Gebratene Mie-Nudeln mit knackigem Gemüse, Bambussprossen und aromatischen Pilzen in würziger Soße. Wie vom Asia-Imbiss, ganz einfach selbst gemacht.", 
    ...
    ingredients: { 
        ...
        "Gemüse": [ 
            "250 g Karotten", 
            "6 g getrocknete Austernseitlinge", 
            "1 Glas Bambussprossen <i>(à 180 g Abtropfgewicht)</i>", 
            "1 große weiße Zwiebel", 
            "250 g Weißkohl <i>(ohne Strunk)</i>" 
        ] 
    }, 
 
    /* 👨‍🍳 ZUBEREITUNG */ 
    steps: [ 
        "Einen Topf mit Salzwasser zum Kochen bringen und die Pilze in einer kleinen Schale mit heißem Wasser einweichen.", 

        "Die Mie-Nudeln nach Packungsbeilage in dem Salzwasser kochen, abgießen, kalt abspülen und mit etwas (Sesam-)Öl vermengen, sodass sie nicht zusammenkleben.", 

        "Die Zwiebel schälen, halbieren, jede Hälfte erneut vierteln und in viereckige Scheiben schneiden. Die Karotten schälen, die Enden entfernen und in dünne, kurze Stifte schneiden. Den Kohl in Streifen und diese in Vierecke schneiden. Die Bambussprossen abgießen und gut abtropfen. Die Pilze gut ausdrücken, 2 EL des Wassers für die Soße aufheben und die Pilze fein hacken.", 

        "Für die Soße den Knoblauch schälen, pressen und mit der Sojasoße, dem Sesamöl, dem Reisessig, dem Pilzwasser, dem Hühnerbrühepulver und dem Zucker vermengen.", 

        "In einem großen Wok so viel Öl erhitzen, dass der Boden gut bedeckt ist. Die Pilze hineingeben und 2 min braten, dann die Zwiebeln dazugeben und weitere 2 min mitbraten, daraufhin die Karotten dazugeben und ebenfalls 2 min mitbraten. Dann den Kohl 3-4 min mitbraten, bis er etwas Farbe bekommen hat, die Bambussprossen dazugeben und weitere 2 min mitbraten. <b>(Alles unter ständigem Rühren und auf höchster Stufe)</b>", 

        "Die Nudeln unterrühren, bis sie gut mit dem Gemüse vermischt sind.", 
 
        "Dann in der Mitte eine Lücke formen, sodass der Boden zu sehen ist. Die Soße hineinschütten und sofort gut untermischen, 1-2 min fertig braten und servieren.", 
    ] 
},
...
{ 
    ...
    description: "Der schnelle Klassiker-Salat – so einfach, dass man eigentlich gar kein Rezept braucht...",
    ...
    ingredients: { 
        ...
        "": [ 
            "1 kg kleine Tomaten", 
            "6 Mozzarellakugeln <i>(à 250 g)</i>", 
            "2 EL Balsamicocreme",
    ...
    /* 👨‍🍳 ZUBEREITUNG */ 
    steps: [ 
        "Die Tomaten halbieren oder je nach Größe dritteln.",
        "Den Mozzarella abgießen und in Würfel schneiden.",
        "Alles mit der Balsamicocreme und dem Basilikum in eine Schüssel geben, salzen, pfeffern und gut vermengen."
    ]
},
{  
    id: "73",  
    title: "Fluffiges Focaccia",  
    tips: [ 
    ...
    description: "Herrlich fluffiges, luftiges Focaccia – perfekt als Beilage, zum Dippen oder einfach pur.", 
     
    /* 🍽️ ZUTATEN */  
    ingredients: {  
  
        "Teig": [  
            "400g Mehl <i>(Type 550)</i>",  
            "3g Trockenhefe",  
            "8g Salz",  
            "325ml lauwarmes Wasser <i>(ca. 35°C)</i>",  
            "12g Olivenöl"
        ],
    ...
    /* 👨‍🍳 ZUBEREITUNG */  
    steps: [  
        "Das Mehl, die Hefe und das Salz in einer rechteckigen oder quadratischen Form mit Deckel vermischen, in der Mitte eine Mulde formen, Wasser und Öl dazugeben und alles mit einem Löffel so lange verrühren, bis kein trockenes Mehl mehr zu sehen ist. Die Box mit dem Deckel verschließen und 15 min in der Küche stehen lassen.", 
 
        "Anschließend eine Falttour mit dem Teig machen, d. h. mit feuchten Händen immer eine Ecke des Teiges nehmen, ziehen, bis man einen Widerstand spürt, und die Ecke zur Mitte falten. Dies mit allen Seiten rundherum wiederholen, die Box wieder mit dem Deckel verschließen und weitere 15 min ruhen lassen.", 
 
        "Daraufhin den Faltvorgang wiederholen. 30 min ruhen lassen und einen Coil Fold verüben, d. h. den Teig mit feuchten Händen in der Mitte von beiden Seiten nehmen, nach oben ziehen, sodass sich die beiden Enden unten zusammenklappen, und wieder in die Box legen, sodass die zusammengeklappten Enden unten liegen. Die Box um 90 Grad drehen und von der anderen Seite wiederholen. Den Teig wieder abdecken und 30 min ruhen lassen.", 
 
        "Eine zweite rechteckige oder quadratische Box mit etwas Olivenöl einpinseln, erneut einen Coil Fold verüben, jedoch beim zweiten Mal in die gefettete Box legen. Die Box mit Frischhaltefolie abdecken und ca. 16-18 Std. im Kühlschrank gehen lassen.", 
 
        "Am nächsten Tag eine größere Auflaufform (oder ein Blech), 20 cm × 30 cm, etwas einölen, ein Backpapier darauflegen und dieses mit Olivenöl einpinseln. Den Teig vorsichtig in die Auflaufform gleiten lassen. <b>(Am besten geht es, wenn du die Teigbox umdrehst und den Teig hineingleiten lässt.)</b> Die Enden etwas in die Ecken ziehen, sodass der Teig gleichmäßig in der gesamten Form verteilt ist. Mit Frischhaltefolie abdecken und ca. 2 Std. warm <i>(ca. 24-28 Grad, z. B. im abgeschalteten Ofen mit eingeschalteter Lampe)</i> ruhen lassen, bis sich das Volumen verdoppelt hat und sich dünne Luftblasen gebildet haben.", 
 
        "30 min vor Ende der Ruhezeit den Backofen auf 230 Grad Ober-/Unterhitze vorheizen. Den Knoblauch schälen und in Scheiben schneiden.", 
 
        "Den Teig mit reichlich Olivenöl beträufeln und mit den Fingerspitzen einmal vollständig „massieren“, sodass mehr dünne Luftblasen entstehen. Mit Toppings toppen, Salz darüber streuen und im vorgeheizten Backofen auf der unteren Schiene ca. 22 min backen, bis es goldbraun bis braun ist.", 
 
        "Aus dem Ofen nehmen, ohne das Backpapier auf ein Kuchenrost legen, mit Olivenöl bestreichen und mind. 15 min abkühlen lassen.", 
    ] 
},
{  
    id: "74",  
    ...
    description: "Herzhafte Kaspressknödel mit würzigem Graukäse und Bergkäse, knusprig goldbraun in Butterschmalz ausgebacken – einfach, deftig und unglaublich lecker.", 
    ...
    ingredients: {  
        ...
        "Teig": [  
            ...
            "25 g Butter", 
            "1 weiße Zwiebel", 
            "100 g Graukäse <i>(mager)</i>", 
            "200 g Bergkäse <i>(mind. 3 Monate gereift)</i>", 
            "Salz", 
            "Pfeffer", 
            "1 Prise Muskat", 
        ],  
    ...
    steps: [  
        { 
            text: "Die Eier verquirlen."
        }, 
 
        {
            text: "Das Knödelbrot in eine große Schüssel geben, mit einem Löffel mit der lauwarmen Milch <b>(starte ruhig erstmal mit 50 ml weniger Milch und gib nach Bedarf noch mehr dazu, falls es dir zu trocken erscheint)</b> und den verquirlten Eiern gut vermengen und ca. 15 min ruhen lassen."
        }, 
        
        {
            text: "In der Zwischenzeit die Zwiebel schälen und fein hacken. Die Butter in einem Topf schmelzen, bis sie sprudelt, dann die Zwiebel dazugeben, unter gelegentlichem Rühren ca. 4-5 min braun anbraten, vom Herd nehmen und etwas abkühlen lassen."
        }, 
 
        {
            text: "Währenddessen den Käse in kleine Würfelchen schneiden und beide Sorten gut miteinander vermischen."
        }, 
 
        {
            text: "Dann Salz, Pfeffer, Muskat und die Zwiebeln <i>(samt Bratfett)</i> unter die Brotmasse mengen. Den Käse unterheben, bis alles gleichmäßig verteilt ist."
        }, 
 
        {
            text: "Mit feuchten Händen 15 Kugeln à 75 g formen und diese etwas flach drücken (ca. 2 cm dick).",
            images: [ 
                "images/kaaspressknödel-formen.jpeg" 
            ] 
        }, 
...

{
    ...
    description: "Herzhaftes Kartoffel-Fenchelblech mit süßen Weintrauben und cremigem Blauschimmelkäse – einfaches Ofengericht mit einer herrlichen Kombination aus herzhaften und süßen Aromen.",
    ...
    steps: [
        ...
        "Die grünen Stängel und das Ende vom Fenchel entfernen und den Fenchel in grobe Stifte schneiden. Die Kartoffeln vierteln oder je nach Größe achteln.",

        "Beides zusammen auf ein Backblech geben, reichlich Olivenöl darübergeben, gut salzen und pfeffern und alles gut miteinander vermengen.",

        "Möglichst flach auf dem Blech verteilen, die Zitronenschale gleichmäßig darüberstreuen und im vorgeheizten Backofen auf mittlerer Schiene ca. 40 min backen, bis die Kartoffeln gar sind.",

        "In der Zwischenzeit die Trauben vom Stiel lösen und gut abwaschen. Den Blauschimmelkäse in Scheiben schneiden. Das Blech aus dem Ofen holen, den Käse und ca. 1/3 der Trauben darauf verteilen und im Ofen ca. 5 min fertig backen, bis der Käse schön zerlaufen ist."
...
{
    id: "82",
    title: "Brioche mit Übernachtgare",
    tips: [
    ...
    description: "Fluffige Brioche mit herrlich weicher Krume und einer leicht buttrigen Note – dank Übernachtgare besonders aromatisch und am nächsten Tag frisch gebacken genießen.",
    ...
    ingredients: {
        ...
        "Teig": [
            "500 g Mehl (Type 550)",
            "2 Eier",
            "200 ml lauwarme Milch <i>(ca. 30 °C)</i>",
            "50 g Zucker",
            "3 g Trockenhefe",
            "8 g Salz",
            "120 g weiche Butter"
    ...
    steps: [
        ...
        "Das Mehl mit dem Zucker, dem Salz und der Hefe vermengen, in der Mitte eine Mulde formen und die Eier sowie die Milch hineingeben. Alles mit dem Knethaken der Küchenmaschine auf mittlerer Stufe etwa 5 min zu einem glatten, elastischen Teig kneten.",

        "In der Zwischenzeit die weiche Butter in kleine Stücke schneiden.",

        "Dann in den nächsten 2–3 min die Butter Stück für Stück bei mittlerer Stufe einarbeiten. Daraufhin weitere ca. 5–8 min auf mittlerer bis höchster Stufe kneten, bis ein sehr elastischer, weicher und leicht klebriger Teig entsteht.",

        "Eine Schüssel leicht mit Öl einfetten, den Teig mit einem Löffel hineingeben, direkt an der Oberfläche locker mit Frischhaltefolie abdecken, ca. 1 Stunde bei Raumtemperatur ruhen lassen und dann über Nacht für ca. 12 Stunden im Kühlschrank gehen lassen.",

        "Am nächsten Tag den Teig in 8 Teile à ca. 119 g teilen und jedes Teil zu einer Kugel rundformen, d. h. flach drücken, die Ränder rundherum zur Mitte falten, das Teigstück umdrehen, sodass die Naht nach unten zeigt, und mit den Handaußenseiten zu Kugeln rundwirken. <b>(Nicht wundern, der Teig ist über Nacht sehr kompakt geworden. Dadurch lässt er sich jedoch super ohne jegliches Mehl formen.)</b>",

        "Eine Kastenform <i>(30 cm × 11 cm)</i> einfetten und die Kugeln etwas ausrollen, sodass sie eine ovale Form erhalten, je zwei nebeneinander in die Form geben, alles mit Milch bestreichen, abdecken und für ca. 1 1/2 Stunden im Ofen bei 30 Grad ruhen lassen, bis sich das Volumen deutlich vergrößert hat. Dann aus dem Ofen nehmen und den Ofen auf 190 Grad Ober-/Unterhitze mit einer feuerfesten Schale, gefüllt mit Wasser, vorheizen.",

        "Das aufgegangene Brioche erneut großzügig mit Milch bestreichen und im vorgeheizten Backofen im unteren Drittel ca. 30 min backen. Dabei nach ca. 15 min Backzeit die Wasserschale aus dem Ofen entfernen und das Brot locker mit Alufolie abdecken. Dann gegebenenfalls die Temperatur auf 170 Grad reduzieren, die Alufolie entfernen und weitere 5–10 min fertig backen, bis es beim leichten Drücken in die Mitte zurückfedert.",

        "Das Brot nach dem Backen aus dem Ofen holen, die Oberfläche sofort mit einem kleinen Stück Butter einreiben und vor dem Lösen aus der Form mind. 15 min abkühlen lassen."
...

{
    ...
    description: "Goldbraunes French Toast-außen knusprige und innen herrlich weiche– perfekt mit Schokocreme, Ahornsirup, Eiscreme oder frischen Beeren.",
    ...
    ingredients: {
        ...
        "Außerdem": [
            "105 g Butter",
            "10 dicke Scheiben [[brioche-mit-uebernachtgare|Brioche]] <i>(ca. 2,5 cm dick)</i>"
        ]
    ...
    steps: [
        ...
        "Für die Tränke die Eier mit einem Schneebesen in einer großen Schale gut verquirlen, bis sich Eigelb und Eiweiß gut verbunden haben.",

        "Weißen und braunen Zucker, Zimt, Salz, Vanilleextrakt und Muskat unterrühren, die Milch dazugeben und alles gut mit dem Schneebesen <i>(bzw. falls sich der Zimt nicht richtig auflöst, mit einem Milchaufschäumer)</i> gut verrühren.",

        "25 g Butter in einer beschichteten Pfanne schmelzen, bis sie sprudelt.",

        "Währenddessen 2 Scheiben Brot in der Tränke für ca. 30 sek pro Seite einweichen, aus der Tränke nehmen, kurz abtropfen lassen, in die Pfanne geben und für ca. 3–4 min pro Seite bei mittlerer Hitze goldbraun und knusprig ausbacken und mit Topping nach Wahl servieren. <b>(Beim Braten immer wieder die Pfanne schwenken, damit die Butter auch unter die Brote läuft.)</b>",

        "Den Vorgang für alle weiteren Brotscheiben wiederholen, bis alle Brotscheiben aufgebraucht sind, <i>jedoch reichen bei den nächsten Durchgängen 20 g Butter.</i>"
    ]
},

{
    ...
    description: "Frischer mexikanischer Salat mit knackigem Gemüse, cremiger Avocado, würzigen Schwarzbohnen und geröstetem Mais – einfach, vegan und voller Geschmack.",
    ...
    ingredients: {
        ...
        "Salat": [
            "1/2 Eisbergsalat",
            "1 Dose Schwarzbohnen <i>(à 400 g)</i>",
        ...
        "Mais": [
            "1 Dose Mais <i>(à 340 g)</i>",
            "1 TL Kreuzkümmelpulver",
            "1/2 TL Korianderpulver",
            "1/4 TL Chiliflocken",
            "1 TL Paprikapulver <i>geräuchert</i>",
            "1 Knoblauchzehe",
            "Salz",
            "Pfeffer",
            "1 EL Olivenöl"
    ...
    steps: [
        ...
        "Den Salat kleinschneiden, abwaschen und gut trocken tupfen.",

        "Danach die Gurke schälen und sowie die Paprika in kleine Würfel schneiden. Die Schwarzbohnen abgießen, abspülen und abtropfen lassen. Die Tomaten halbieren oder je nach Größe dritteln.",

        "Alles, bis auf die Avocados und den Mais, in eine große Schüssel geben.",

        "Die Frühlingszwiebeln klein schneiden und mit dazugeben.",

        "Dann das Öl in einer Pfanne erhitzen. Den Mais abgießen, die Gewürze in einer kleinen Schüssel mit Salz und Pfeffer vermengen und den Knoblauch schälen und fein hacken. Die Gewürzmischung mit in die Pfanne zu dem Öl geben und kurz anschwitzen, bis es duftet. Mais und Knoblauch dazugeben, kurz durchmischen und bei hoher Hitze ca. 10 min anrösten, bis der Mais leicht gebräunt ist. <b>(Dabei möglichst wenig rühren, damit er Farbe bekommt.)</b>",

        "Etwas Limettensaft sowie den Mais mitsamt der Bratflüssigkeit in den Salat geben, alles vermengen und ca. 10 min ziehen lassen.",

        "In der Zwischenzeit den Kern und die Schale von den Avocados entfernen und die Avocados in kleine Würfel schneiden, vorsichtig mit unterheben und servieren."
    ]
},

{
    ...
    description: "Weiche, fluffige Frühstücksbrötchen, in nur 35 min auf dem Tisch – ohne lange Gehzeit, perfekt, wenn’s schnell gehen muss.",

    /* 🍽️ ZUTATEN */
    ingredients: {

        "Teig": [
            "300 g Mehl <i>(Type 505)</i>",
            "135 ml lauwarmes Wasser",
            "62 ml lauwarme Milch <i>(ca. 30 °C)</i>",
    ...
    steps: [
        ...
        "Das Mehl mit dem Salz, dem Zucker und der Hefe vermengen, in der Mitte eine Mulde formen, die Milch, das Wasser und das Öl dazugeben und alles mit einem Löffel vermengen, bis sich alle Zutaten einigermaßen verbunden haben.",

        "Dann mit dem Knethaken der Küchenmaschine ca. 3 min auf höchster Stufe zu einem elastischen, leicht klebrigen Teig kneten.",

        "Den Teig auf eine leicht bemehlte Arbeitsfläche geben und in 6 Stücke à ca. 86 g teilen. Jedes Teigstück zu einer Kugel rundwirken. <b>D. h. jedes Teigstück flach drücken, rundherum den Rand zur Mitte falten, das Teigstück umdrehen, die Hand zu einer „Klaue“ formen und damit das Teigstück so bearbeiten, dass es Spannung bekommt und seine Kugelform hält.</b>",

        "Alle Kugeln auf ein mit Backpapier belegtes Backblech legen. Mit einem Küchentuch abdecken und 15 min im Ofen bei 30 Grad ruhen lassen.",

        "Nach der Ruhezeit die Brötchen aus dem Ofen nehmen und den Ofen auf 220 Grad Ober-/Unterhitze vorheizen.",

        "Wenn der Ofen vollständig aufgeheizt ist, das Tuch von den Brötchen nehmen, jedes rundherum mit etwas Milch bestreichen, das Blech in den Ofen schieben, etwas Wasser auf den Ofenboden schütten, sofort die Ofentür schließen und die Brötchen ca. 12–15 min backen, bis sie schön goldbraun sind und sich beim Klopfen auf die Unterseite hohl anhören. Die Brötchen aus dem Ofen nehmen und kalt oder warm servieren."
...
{
    id: "86",
    title: "Cremige Kürbispasta",
    category: ["Pasta", "Hauptgerichte", "Kochen"],
    image: "images/cremige-kürbispasta.jpeg",
    time: {
        preparation: "15 min",
        cooking: "20 min",
        total: "35 min"
    ...
    description: "Cremige Kürbispasta mit würzigem Ziegenfrischkäse, knusprigem Bacon und einer herrlich aromatischen Kürbissoße – einfach, schnell und perfekt für kalte Herbsttage.",

    /* 🍽️ ZUTATEN */
    ingredients: {

        "Soße": [
            "1 Butternutkürbis <i>(ca. 950 g)</i>",
            "20 g Butter",
    ...
    steps: [
        ...
        "Einen Topf mit Salzwasser zum Kochen bringen, den Kürbis schälen, die Kerne mit einem Löffel entfernen und den Kürbis in kleine Stücke schneiden.",

        "Die Zwiebeln sowie den Knoblauch schälen, die Zwiebeln grob hacken und den Knoblauch halbieren.",

        "Die Butter in einem beschichteten Topf erhitzen, bis sie sprudelt, die Zwiebeln dazugeben und ca. 3–4 min auf höchster Stufe unter gelegentlichem Rühren goldbraun anbraten.",

        "Den Knoblauch dazugeben und kurz mitbraten, bis es duftet, dann den Kürbis hinzufügen und mit Salz und Pfeffer ca. 12 min bei höchster Stufe unter gelegentlichem Rühren weich braten. <b>(Am besten während du nicht rührst, den Deckel auf den Topf setzen, dann wird der Kürbis schneller gar.)</b>",

        "Nach ca. 7 min Bratzeit die Nudeln in das kochende Salzwasser geben und das Muskat unter den Kürbis rühren.",

        "Während der Kürbis brät, ein Backblech mit Backpapier belegen, den Bacon darauf verteilen und bei höchster Grillstufe auf höchster Schiene ca. 7 min schön knusprig backen. <b>(Achtung, er verbrennt schnell!)</b>",

        "Wenn der Kürbis weich ist <i>(d. h. du ihn mit dem Kochlöffel zerdrücken kannst)</i>, den Topf vom Herd nehmen, den gesamten Inhalt in einen Mixer geben, zunächst 2 Kellen des Pastawassers abschöpfen und mit in den Mixer geben. Den Ziegenfrischkäse sowie das Kürbiskernöl dazugeben und alles cremig pürieren. <b>(Wenn die Soße zu dickflüssig ist, einfach nach und nach mehr Pastawasser abschöpfen und zur Soße geben. Ich habe ca. 3 1/2 Kellen verwendet.)</b>",

        "Wenn die Nudeln gar sind, abgießen und unter die Soße heben. Den Bacon in kleine Stücke hacken und als Topping für die Pasta servieren."
