...

{
    ...
    steps: [
        ...
        {text: "Das Mehl mit dem Zucker, dem Salz und der Hefe vermengen, in der Mitte eine Mulde formen und die Eier sowie die Milch hineingeben. Alles mit dem Knethaken der Küchenmaschine auf mittlerer Stufe etwa 5 min zu einem glatten, elastischen Teig kneten.",
        },
        {
        text: "In der Zwischenzeit die weiche Butter in kleine Stücke schneiden.",
        },

        {text: "Dann in den nächsten 2–3 min die Butter Stück für Stück bei mittlerer Stufe einarbeiten. Daraufhin weitere ca. 5–8 min auf mittlerer bis höchster Stufe kneten, bis ein sehr elastischer, weicher und leicht klebriger Teig entsteht.",
        },
        {text:"Eine Schüssel leicht mit Öl einfetten, den Teig mit einem Löffel hineingeben, direkt an der Oberfläche locker mit Frischhaltefolie abdecken, ca. 1 Stunde bei Raumtemperatur ruhen lassen und dann über Nacht für ca. 12 Stunden im Kühlschrank gehen lassen.",
        },
        {text:"Am nächsten Tag den Teig in 8 Teile à ca. 119 g teilen und jedes Teil zu einer Kugel rundformen, d. h. flach drücken, die Ränder rundherum zur Mitte falten, das Teigstück umdrehen, sodass die Naht nach unten zeigt, und mit den Handaußenseiten zu Kugeln rundwirken. <b>(Nicht wundern, der Teig ist über Nacht sehr kompakt geworden. Dadurch lässt er sich jedoch super ohne jegliches Mehl formen.)</b>",
